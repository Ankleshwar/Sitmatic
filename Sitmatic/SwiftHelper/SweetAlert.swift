...
open class SweetAlert: UIViewController {
    ...
    fileprivate func resizeAndRelayout() {
        ...
        for button in buttons {
            ...
            buttonRect.append(string.boundingRect(with: CGSize(width: width, height:0.0), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes:nil, context:nil))
        }
